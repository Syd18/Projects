%%Jaya Algorithm (Unconstrained Continuous Problem)

%function JayaUnconstrainedContinuous()
clc
clear all
MaxRuns=8;
run=0;
...
maximum_fun_eval=5000;
termination_criteria=floor(maximum_fun_eval/population_size);
lower_bound=-30*ones(1,variables);
upper_bound=30*ones(1,variables);
