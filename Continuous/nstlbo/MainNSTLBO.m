...
FunctionEvaluation=0; %initial function evaluation
Max_FunctionEvaluation=30000; %maximum function evaluation
Generation=0;
...
while(FunctionEvaluation<=Max_FunctionEvaluation)
...
Combined_Pop=[];
PopulationNew=[];
FunctionEvaluation=FunctionEvaluation+PopulationSize; 
disp(FunctionEvaluation);
